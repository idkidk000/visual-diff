...
Fully keyboard navigable with `ctrl+k` to focus the nav controls and `ctrl+f` to toggle fullscreen.
...
[It's hosted on Github pages](https://idkidk000.github.io/visual-diff/) but your browser will block iframing plain HTTP content since the app was served over HTTPS, so you will need to run it locally for that.
